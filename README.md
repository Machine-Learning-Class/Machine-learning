...
本课程目前采用的PPT教案为全英文，主要来自于[香港科技大学计算机学院张连文教授]https://www.cse.ust.hk/faculty/lzhang/的本科教学材料及[原斯坦福大学Andrew Ng教授开设的Machine Learning课程]https://www.coursera.org/learn/machine-learning，在此向两位教授表示感谢. PPT教案内容考虑到生物医学相关专业本科生的接受程度进行了系统的梳理，在讲解过程中注重突出算法和模型的核心思想，兼顾一些数学公式的推导，并突出各种模型算法之间的关系以及具体的应用场景。
<br>
